...
uint256 hashGenesisBlock("0x00000000c877c2f04290f43f196e92b635668bd71a0840e4d6b944894dbfd416"); //uint256 hashGenesisBlock("0x000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "China bans banks from handling Bitcoin trade"; //const char* pszTimestamp = "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04068a996763dfdb3cc882b58c9b01e03d445304d829822a3c06b4fe8d716ad5210a6d08e102320f589cf7e13eccae647e95e2c359f5f66e06c3de5ff508c18bc5") << OP_CHECKSIG; //04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1386464300; //1231006505;
        block.nBits    = 0x1d00ffff;
        block.nNonce   = 483329189; //2083236893;

        if (fTestNet)
        {
            block.nTime    = 0;//1296688602;
            block.nNonce   = 0;//414098458;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x07b2f1e637c1bcbbf61812b0d12eedba1ea81dc702b83117816750ed59265ada")); //uint256("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        block.print();
